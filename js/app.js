...
<div class="card card-body flashcard my-3">
     ...
     <a href="#" class="text-capitalize my-3 show-answer">mostrar/ocultar respuesta</a>
     ...
     <a href="#" id="delete-flashcard" class=" btn my-1 delete-flashcard text-uppercase">borrar</a>
     </div>
    </div>
`;
